    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 bg-gradient-to-br from-blue-500 to-blue-700 rounded-[2.5rem] p-8 text-white shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex items-center justify-between mb-8">
                            <div>
                                <span className="text-7xl font-extrabold tracking-tighter">26°</span>
                                <span className="text-2xl text-blue-200 align-top">C</span>
                                <p className="text-xl font-medium mt-2 text-blue-100">Partly Cloudy</p>
                            </div>
                            <CloudRain className="h-24 w-24 text-blue-100 drop-shadow-xl" />
                        </div>
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 shadow-xl border border-slate-100 h-[350px]">
                        <h3 className="text-xl font-bold text-slate-800 mb-6">Today's Temperature Trend</h3>
                    ...
                    <div className="bg-blue-50 rounded-[2.5rem] p-8 border border-blue-100 shadow-sm relative overflow-hidden">
                        ...
                        <ul className="space-y-4 relative z-10">
                            <li className="flex items-start gap-4">
                                ...
                                <p className="text-slate-700 text-lg leading-relaxed font-medium">Clear weather suitable for harvesting mature crops.</p>
                            </li>
                            <li className="flex items-start gap-4">
                                <div className="mt-1 w-2 h-2 rounded-full bg-blue-500 shrink-0"></div>
                                <p className="text-slate-700 text-lg leading-relaxed font-medium">Delay pesticide application. Wind speeds are moderate but may increase in the afternoon causing spray drift.</p>
                            </li>
                            <li className="flex items-start gap-4">
                                <div className="mt-1 w-2 h-2 rounded-full bg-blue-500 shrink-0"></div>
                                <p className="text-slate-700 text-lg leading-relaxed font-medium">Optimal conditions for soil preparation for the next planting cycle.</p>
                            </li>
                        </ul>
                    </div>
                </div>
